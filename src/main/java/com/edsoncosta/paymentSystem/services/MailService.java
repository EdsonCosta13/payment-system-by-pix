...
public class MailService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException
    {
        ...
        MimeMessage message=emailSender.createMimeMessage();//É uma padronização de dados do email
        MimeMessageHelper helper=new MimeMessageHelper(message); //vai ajudar a criar a mimeMessage
